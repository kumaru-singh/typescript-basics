...
*/
function processTransaction ( amount : number, desc : string | undefined , isCredit : boolean ) : void {

    

    function negativeAmount (): never {
    ...
    const description = desc  ===  undefined ? " No description provided " : desc;
    console.log(` Summary of the transaction is -> Amount : ${amount}, Description : ${description}, IsCredit : ${isCredit}`);
}
